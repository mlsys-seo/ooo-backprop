...
def prepare_cuda_graph_capture():
  cuda_graph_dummy_var = tf.Variable(
      tf.random.normal([1, 1]), dtype="float", name="cuda_graph_dummy_var"
  )
  cuda_graph_run_op = cuda_graph_run(cuda_graph_dummy_var)

  return cuda_graph_run_op
