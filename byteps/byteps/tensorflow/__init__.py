...
from byteps.tensorflow.ops import _comm_terminal
from byteps.tensorflow.ops import _polling_data

def comm_terminal(input_tensor):
    return _comm_terminal(input_tensor)

def polling_data(DUMMY_PLACEHOLDER, op_index, s0, s1, s2, s3):
